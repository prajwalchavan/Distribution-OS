#!/bin/bash
cd "$(dirname "$0")"
until grep -q ALL_DONE /private/tmp/claude-501/-Users-prajwalchavan-Desktop-Distribution-OS/bdc392e9-21d1-4d15-9ffa-7a88c7db4de9/logs/android-redo.log; do sleep 10; done
export PATH=/opt/homebrew/bin:$PATH; eval "$(fnm env)"; fnm use 24 >/dev/null
for spec in "delivery 5177 ganesh.more Delivery"; do
  set -- $spec; echo "=== $1 ==="
