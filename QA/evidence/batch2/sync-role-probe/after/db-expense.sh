#!/bin/bash
# QA batch 2 — sync role probe AFTER the DOS-166 merge: what one trip_expenses probe left in dos_qa.
# Copied from ../db-expense.sh (original unchanged); queries are identical, output lands next to this file.
