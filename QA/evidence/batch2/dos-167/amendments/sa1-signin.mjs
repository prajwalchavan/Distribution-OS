// DOS-167 Android SALES sanity walk — step 1: sign in as the driver (Appium/UiAutomator2).
// node sa1-signin.mjs <username> <shotPrefix>
import * as A from './sa-appium.mjs'

const user = process.argv[2] || 'rahul.deshmukh'
const prefix = process.argv[3] || 'sa-01'
const PASS = 'Dos@1234'
