...
## RESUME HERE (updated 2026-09-06 23:00 IST, session 3)
...
15 737 rows** land, go offline, queue an order, watch it appear at once marked *queued*, come back,
...
1. **The device pulled ONCE per launch and then never again — and said "Offline" the whole time.**
   ...
   *the radio is on and the last call reached a service*; the poll is never gated on the state it
