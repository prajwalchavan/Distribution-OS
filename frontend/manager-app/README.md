...
Talks to the **Manager service** on port 3002 (`EXPO_PUBLIC_API_URL=http://localhost:3002`). Runs on its own: start the service, then the app.
...
Full request/response samples for each are in `backend-services/manager-service/README.md`.
