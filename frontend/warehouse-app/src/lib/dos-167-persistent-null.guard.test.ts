...
const SCREENS: readonly Screen[] = [
  { path: '../../app/settings.tsx', memoryKey: 'x4.storeMemory', diskKey: 'x4.storeDisk' },
  { path: '../../app/pick/attention.tsx', memoryKey: 'x4.storeMemory', diskKey: 'x4.storeDisk' },
]
...
describe('DOS-167 the warehouse app never says "held in memory only" before the store has resolved', () => {
  it('DOS-167 every warehouse screen hides the store line while persistent is null and shows it on a resolved memory store', async () => {
