/**
 * DOS-167 ruling 3 (dd), S-139 — the delivery app's offline lines have somewhere to go.
 *
...
describe('DOS-167 the delivery app writes the offline lines somewhere they can be read', () => {
  it('DOS-167 the delivery app passes onLog to OfflineProvider', async () => {
