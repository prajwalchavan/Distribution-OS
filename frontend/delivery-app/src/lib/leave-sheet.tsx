/**
 * DOS-167 — the sheet a driver sees on signing out, or switching distributor, while this phone still
 * holds deliveries, receipts or returns the office has not got.
 *
 ...
 * there is a signal, or leave keeping them on this phone for this person only. Throwing a delivery away
 * is never offered here — that stays in the Needs-attention tray with its audit line.
 *
