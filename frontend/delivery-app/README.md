...
Talks to the **Delivery service** on port 3005 (`EXPO_PUBLIC_API_URL=http://localhost:3005`). Runs on its own: start the service, then the app.
...
Full request/response samples for each are in `backend-services/delivery-service/README.md`.
