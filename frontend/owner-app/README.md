...
Talks to the **Owner service** on port 3001 (`EXPO_PUBLIC_API_URL=http://127.0.0.1:3001; EXPO_PUBLIC_AUTH_URL=http://127.0.0.1:3000`). Runs on its own: start the service, then the app.
