/**
 * The furniture every owner screen shares, composed ONLY from the `@dos/ui` contract.
 *
...
/**
 * "Every list is exportable" (the owner brief) goes through `reporting.exports.request`: the worker
      ...
      <Button
        ...
        onPress={() => {
          if (ready !== null) {
            ...
            const absolute = absoluteUrl('owner', ready)
