...
export const strings = {
  ...
  /* DOS-235: a trip settlement the desk could not close — what it is, and what approving it does. */
  'o3t.trip': 'Trip',
  'o3t.tripLine': '{trip} · {date}',
  'o3t.expected': 'Cash the crew should hand over',
  'o3t.expectedHow': 'Float {float} + cash taken {taken} − expenses {spent}',
  'o3t.handed': 'Cash handed over',
  'o3t.difference': 'Difference',
  'o3t.short': '{amount} short',
  'o3t.over': '{amount} over',
  'o3t.exact': 'Cash tallies',
  'o3t.allowed': 'You allow {amount} either way',
  'o3t.otherMoney': 'Also taken on this trip',
  'o3t.otherMoneyLine': 'UPI {upi} · cheques {cheques}',
  'o3t.stock': 'Van count',
  'o3t.stockTallies': 'Every lot on the van was counted back',
  'o3t.stockLine': 'Should be {expected} pc · counted {counted} pc',
  'o3t.missing': '{count} pc missing',
  'o3t.extra': '{count} pc extra',
  'o3t.atCost': '{value} at cost',
  'o3t.noCost': 'no cost on file',
  'o3t.stockTotal': 'Pieces written off the van: {missing} · at cost {value}',
  'o3t.approveCash': 'Approving settles {trip} now: cash {cash}.',
  'o3t.approveStock': '{count} pc are taken off the van as missing ({value} at cost).',
  'o3t.approveExtra': '{count} pc found extra are added back.',
  'o3t.approveBank': "Then the trip's cash and cheques can be banked.",
  'o3t.rejectSays': '{trip} stays open, and the desk counts the cash and the van again.',
  'o3t.settled': '{trip} settled with a variance',
  'o3t.sentBack': '{trip} sent back to the desk',
  'o3t.unreadable': 'This request carries no count. Ask the desk to settle the trip again.',
