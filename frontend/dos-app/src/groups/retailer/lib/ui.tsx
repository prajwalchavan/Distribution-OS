 ...
 * its own; `PageTabs` is the level-2 tab row of §8.1 rendered from `src/groups/retailer/nav.ts`;
 * `TwoLine` is the §6.6 row where the trailing stack needs two figures, which `<ListRow>`
