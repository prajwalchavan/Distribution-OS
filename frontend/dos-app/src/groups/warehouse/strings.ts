...
export const strings = {
  ...
  'w1.receiptsN': '{count} receipts',
  'w1.receiptsN.one': '{count} receipt',
  ...
  // DOS-216: the review's word for a figure the server has not acknowledged yet — never "Saved".
  'w3.notSaved': 'Not saved yet',
  'w3.unsaved': '{count} lines not saved yet — press Save the count',
  'w3.unsaved.one': '{count} line not saved yet — press Save the count',
  'w3.goodAndDamaged': '{pieces} pc good · {damaged} pc damaged',
  'w3.saveFailedBecause': 'The count was not saved: {reason}',
  'w3.saveOffline': 'no connection',
  'w3.keptFigures': 'Your figures are still on this screen.',
  'w3.retryOnline': 'Press Save the count again when the signal is back.',
  ...
  'w3.countedWaitsForDesk': 'Counted and saved. The desk posts it into stock next.',
  ...
  'w6.beingPicked': 'BEING PICKED',
  'w6.beingPickedEmpty': 'No order is being picked',
  'w6.pickedOf': '{picked} of {total} pc',
  'w6.shortBy': '{short} pc short',
  'w6.shortNotice': '{picked} of {total} pc picked · {short} pc short.',
  ...
  'w10.plan': 'Plan a trip',
  'w10.planTitle': 'PLAN A TRIP',
  'w10.date': 'Date',
  'w10.today': 'Today',
  'w10.tomorrow': 'Tomorrow',
  'w10.driver': 'Driver',
  'w10.helper': 'Helper',
  'w10.noHelper': 'No helper',
  'w10.float': 'Cash float',
  'w10.bills': 'Packed bills not on a trip',
  ...
  'w10.addBill': 'Add a bill',
  'w10.addBillTitle': 'Add a bill to {trip}',
  'w10.addBillBody': '{shop} · {bills} bills',
  ...
  'w11.forOrderShop': 'For {order} · {shop}',
} as const
