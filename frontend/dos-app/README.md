<!-- GENERATED by `pnpm docs:readme` (endpoint tables) — edit the prose in backend/libs/core/src/docs/readme.ts or the app entry in backend/tools/generate-readmes.mts -->
...
|---|---|---|---|
| Owner | `/owner/…` | Owner service | 3001 |
| Manager and accountant | `/manager/…` | Manager service | 3002 |
| Sales | `/sales/…` | Sales service | 3003 |
| Warehouse | `/warehouse/…` | Warehouse service | 3004 |
| Delivery | `/delivery/…` | Delivery service | 3005 |
| Shop | `/retailer/…` | Retailer service | 3006 |
...
`EXPO_PUBLIC_AUTH_URL=http://127.0.0.1:3000; EXPO_PUBLIC_API_URL is the ALL-IN-ONE base (docs/26 §7) and is left unset locally, where each group talks to its own port`
...
### Manager and accountant (`/manager`)
...
Full request/response samples are in `backend/owner-service/README.md`.
...
### Manager and accountant → Manager service (:3002)

Full request/response samples are in `backend/manager-service/README.md`.
...
### Sales → Sales service (:3003)

Full request/response samples are in `backend/sales-service/README.md`.
...
### Warehouse → Warehouse service (:3004)

Full request/response samples are in `backend/warehouse-service/README.md`.
...
### Delivery → Delivery service (:3005)

Full request/response samples are in `backend/delivery-service/README.md`.
...
### Shop → Retailer service (:3006)

Full request/response samples are in `backend/retailer-service/README.md`.
