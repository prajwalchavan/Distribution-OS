...
import { useItemNames, useMyShop } from '../../../src/groups/retailer/lib/shop'
import { Async, Field, Panel, orderFamily } from '../../../src/groups/retailer/lib/ui'
                          ...
                          <ListRow
                            ...
                            onPress={
                              delivery.invoiceId === null
                                ? undefined
                                : () => {
                                    go.push(`/bills/${delivery.invoiceId}`)
                                  }
                            }
                          />
                        ))}
