...
import { longDate } from '../../../src/groups/retailer/lib/dates'
import { Async, PageTabs, Panel, billFamily } from '../../../src/groups/retailer/lib/ui'
...
export default function Bills(): React.JSX.Element {
  ...
  return (
    <Screen title={t('r4.title')} context={session?.tenant.displayName} testID="r4-screen">
      <Stack gap={5}>
        <PageTabs group={go.href('/dues')} active={go.href('/bills')} />
        <Segments
          testID="r4-filter"
          items={[
