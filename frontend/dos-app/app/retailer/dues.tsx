...
import { longDate, shortDate } from '../../src/groups/retailer/lib/dates'
import { useMyShop } from '../../src/groups/retailer/lib/shop'
import { Async, PageTabs, Panel, TwoLine } from '../../src/groups/retailer/lib/ui'
...
export default function Dues(): React.JSX.Element {
  ...
  return (
    ...
    >
      <Stack gap={6}>
        <PageTabs group={go.href('/dues')} active={go.href('/dues')} />
                ...
                */}
                ...
                <Button
                  ...
                  onPress={() => {
                    ...
                    const bill = qrBillId
                    setQrBillId(null)
                    go.push(bill === null ? '/pay' : `/pay?bill=${bill}`)
                  }}
                  fullWidth
                  testID="r3-qr-pay"
                />
