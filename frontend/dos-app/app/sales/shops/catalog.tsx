...
import { shortDate, today } from '../../../src/groups/sales/lib/dates'
import { keepKey } from '../../../src/groups/sales/lib/keep'
import { useCatalog, useLocalState, useSchemes } from '../../../src/groups/sales/lib/local'
import { useGodownStock } from '../../../src/groups/sales/lib/stock'
import { LocalAsync, PageTabs, Panel } from '../../../src/groups/sales/lib/ui'
import { formatBps } from '../../../src/groups/sales/lib/words'
...
export default function Catalog(): React.JSX.Element {
  ...
  return (
    ...
    >
      <Stack gap={4}>
        <PageTabs group={go.href('/shops')} active={go.href('/shops/catalog')} />
