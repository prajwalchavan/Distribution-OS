...
import { longDate, rangeOf, shortDate, today } from '../../../src/groups/sales/lib/dates'
import { useLocalState } from '../../../src/groups/sales/lib/local'
import { Async, PageTabs, Panel, useMyUserId } from '../../../src/groups/sales/lib/ui'
...
export default function Me(): React.JSX.Element {
  ...
  return (
    ...
    >
      <Stack gap={6}>
        <PageTabs group={go.href('/me')} active={go.href('/me')} />
