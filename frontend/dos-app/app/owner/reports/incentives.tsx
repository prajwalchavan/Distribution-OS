...
import { Async, PageTabs, Panel, moneyColumn, textColumn } from '../../../src/groups/owner/lib/ui'
import { longDate } from '../../../src/groups/owner/lib/dates'
...
export default function Incentives(): React.JSX.Element {
  ...
  return (
    <Screen
      title={t('o20.title')}
      chips={<PageTabs group={go.href('/reports')} active={go.href('/reports/incentives')} />}
      actions={
        <Segments
          value={view}
          onChange={(id) => {
