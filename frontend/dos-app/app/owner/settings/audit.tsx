...
import { auditWho } from '../../../src/groups/owner/lib/support-reads'
import { instantWithClock, rangeOf, type RangeId } from '../../../src/groups/owner/lib/dates'
import { RangeSegments } from '../../../src/groups/owner/lib/ui'
...
export default function Audit(): React.JSX.Element {
  ...
  return (
    <Screen
      ...
      chips={<PageTabs group={go.href('/settings')} active={go.href('/settings/audit')} />}
      actions={
        <>
          <Segments
            value={view}
