...
import { Async, PageTabs, moneyColumn, textColumn } from '../../../src/groups/owner/lib/ui'
import { instantWithClock, rangeOf } from '../../../src/groups/owner/lib/dates'
...
export default function Notifications(): React.JSX.Element {
  ...
  return (
    <Screen
      title={t('o23.title')}
      chips={<PageTabs group={go.href('/settings')} active={go.href('/settings/notifications')} />}
      actions={
        <Segments
          value={view}
          onChange={(id) => {
