...
import { useMoveStop } from '../../../../src/groups/delivery/lib/queue'
import { Field, LocalAsync, Panel, StopChip, pl } from '../../../../src/groups/delivery/lib/ui'
        ...
        terminal ? (
          ...
          <Stack gap={3}>
            <Button
              ...
              fullWidth
              onPress={() => {
                router.push(go.href(`/stop/${stop.id}/collect`))
              }}
            />
            <Button
              testID="d3-back"
          ...
          <Stack gap={3}>
            {open.length === 1 && open[0] !== undefined ? (
              <Button
                ...
                fullWidth
                onPress={() => {
                  router.push(go.href(`/stop/${stop.id}/deliver?deliveryId=${open[0]?.id ?? ''}`))
                }}
              />
            ) : null}
            <Button
        ...
        {terminal ? (
          ...
          <Row gap={8} wrap>
            <Button
              ...
              variant="secondary"
              onPress={() => {
                router.push(go.href(`/stop/${stop.id}/van-sale`))
              }}
            />
