...
import { openingCashEntered, openingCashShown } from '../../../src/groups/delivery/lib/opening-cash'
import { Async, Field, FillingNote, Panel } from '../../../src/groups/delivery/lib/ui'
      ...
      bottomBar={
        onTheRoad && tripId !== null ? (
          <Button
            ...
            fullWidth
            onPress={() => {
              router.replace(go.href(tripEntryHref({ id: tripId, state })))
            }}
          />
        ) : (
          <Button
