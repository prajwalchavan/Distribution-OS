...
import { longDate } from '../../../../src/groups/warehouse/lib/dates'
import { useVariantNames } from '../../../../src/groups/warehouse/lib/local'
import { Async, DeskOnly, Panel, workFamily } from '../../../../src/groups/warehouse/lib/ui'
      ...
      <Stack gap={6}>
        ...
        >
          ...
          <Button
            ...
            variant="ghost"
            onPress={() => {
              router.push(go.href('/stock/counts'))
            }}
            testID="w8c-close"
          />
        </Async>
