...
import { Group, ListRow, Screen, Stack, StatusChip, useGo, useStrings } from '@dos/ui'

import { Async, DeskOnly, Panel, PageTabs, workFamily } from '../../../src/groups/warehouse/lib/ui'
...
export default function Reservations(): React.JSX.Element {
  ...
  return (
    <Screen title={t('w11.title')} context={session?.tenant.displayName} testID="w11-screen">
      <Stack gap={6}>
        <PageTabs group={go.href('/')} active={go.href('/stock/reservations')} />
