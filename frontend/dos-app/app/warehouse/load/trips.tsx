...
import { shiftDays, shortDate, today } from '../../../src/groups/warehouse/lib/dates'
import {
  addStopBody,
  addStopSnapshot,
  mergeBills,
  ...
  type StopPlan,
  type TripPlan,
} from '../../../src/groups/warehouse/lib/trip-plan'
import { Async, Panel, PageTabs, useCan, workFamily } from '../../../src/groups/warehouse/lib/ui'
...
export default function Trips(): React.JSX.Element {
  ...
  return (
    ...
    >
      <Stack gap={6}>
        <PageTabs group={go.href('/load')} active={go.href('/load/trips')} />
