...
Talks to the **Sales service** on port 3003 (`EXPO_PUBLIC_API_URL=http://localhost:3003`). Runs on its own: start the service, then the app.
...
Full request/response samples for each are in `backend-services/sales-service/README.md`.
