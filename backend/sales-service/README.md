...
```bash
curl -X POST "http://localhost:3003/tenancy/staff/update" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /tenancy/staff/update",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/tenancy/memberships/update" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /tenancy/memberships/update",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/tenancy/branding" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3003/tenancy/settings" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3003/tenancy/settings" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /tenancy/settings",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/tenancy/numbering-series?fy=2026-27" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call GET /tenancy/numbering-series",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/tenancy/numbering-series" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /tenancy/numbering-series",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/tenancy/feature-flags" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3003/tenancy/feature-flags" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /tenancy/feature-flags",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/tenancy/tenant" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /tenancy/tenant",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/tenancy/audit?entityType=text&entityId=01a06d21-94b0-7dc3-8aad-22f00b372c7e&actorId=01a06d81-8fbe-749f-8c31-d150f1cb90ee&action=text&from=2026-09-04&to=2026-09-04&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call GET /tenancy/audit",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/tenancy/support-grants?status=requested&openOnly=true&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call GET /tenancy/support-grants",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/tenancy/support-grants/01a06d17-0be7-794a-8dab-9b14cf78673b/approve" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /tenancy/support-grants/{id}/approve",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/tenancy/support-grants/01a06d17-0be7-794a-8dab-9b14cf78673b/revoke" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /tenancy/support-grants/{id}/revoke",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/catalog/hsn-rates?codes=22021010&on=2026-09-04" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3003/tenant-catalog/rep-authorisations?userId=01a06d02-3731-7b6d-8798-5c7c2b7bf340" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3003/tenant-catalog/rep-authorisations" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /tenant-catalog/rep-authorisations",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/tenant-catalog/brands" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3003/tenant-catalog/brands" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /tenant-catalog/brands",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/tenant-catalog/pack-configs?supplierId=01a06d4d-b127-7ad7-815f-92d49a8a08b8&variantId=01a06df0-2faf-79a2-8456-92042e49f147&limit=200" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call GET /tenant-catalog/pack-configs",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/tenant-catalog/pack-configs" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /tenant-catalog/pack-configs",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/retailers/me" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /retailers/me",
  "error": "Forbidden"
}
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /beats",
  "error": "Forbidden"
}
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /beats/{id}/assign",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/beats/assignments?beatId=01a06d3e-cfdb-7635-85cb-ee42f205a04f&userId=01a06d02-3731-7b6d-8798-5c7c2b7bf340&on=2026-09-04&currentOnly=true&limit=100" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3003/pricing/rates?retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd&pricingDate=2026-09-04" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3003/pricing/bounds?userId=01a06d02-3731-7b6d-8798-5c7c2b7bf340" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3003/inventory/availability?variantId=01a06df0-2faf-79a2-8456-92042e49f147&limit=500" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3003/inventory/cycle-counts" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /inventory/cycle-counts",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/inventory/cycle-counts/01a06d17-0be7-794a-8dab-9b14cf78673b/count" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /inventory/cycle-counts/{id}/count",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/inventory/cycle-counts/01a06d17-0be7-794a-8dab-9b14cf78673b/post" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /inventory/cycle-counts/{id}/post",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/inventory/cycle-counts?locationId=01a06d18-e60a-7abc-87f8-910189e5f14c&status=open&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call GET /inventory/cycle-counts",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/inventory/cycle-counts/01a06d17-0be7-794a-8dab-9b14cf78673b" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call GET /inventory/cycle-counts/{id}",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/orders/last-placed?retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3003/orders?state=draft&openOnly=true&retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd&salespersonId=01a06d29-a152-76c4-87b4-301e496c0602&from=2026-09-04&to=2026-09-04&q=campa&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /receipts",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/receipts?retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd&tripId=01a06d0b-bd31-7813-8e79-aa7c39f75385&mode=cash&status=collected&from=2026-09-04&to=2026-09-04&unallocatedOnly=true&withCrew=true&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call GET /receipts",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/receipts/01a06d17-0be7-794a-8dab-9b14cf78673b" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call GET /receipts/{id}",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/receipts/01a06d17-0be7-794a-8dab-9b14cf78673b/document?format=a5" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call GET /receipts/{id}/document",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/receipts/01a06d17-0be7-794a-8dab-9b14cf78673b/reverse" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /receipts/{id}/reverse",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/receipts/deposit" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /receipts/deposit",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/receipts/01a06d17-0be7-794a-8dab-9b14cf78673b/bounce" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /receipts/{id}/bounce",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/receivables/payments/initiate" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /receivables/payments/initiate",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/allocations" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /allocations",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/allocations/01a06d17-0be7-794a-8dab-9b14cf78673b/remove" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /allocations/{id}/remove",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/receivables/outstanding/01a06dbc-35ed-7760-86f2-6c701c68f2dd?includeBills=true" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3003/receivables/outstanding?beatId=01a06d3e-cfdb-7635-85cb-ee42f205a04f&overdueOnly=true&minOutstandingPaise=2680000&bucket=b0_7&q=campa&sort=outstanding&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call GET /receivables/outstanding",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/receivables/credit-check?retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd&orderTotalPaise=0" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3003/receivables/ledger/01a06dbc-35ed-7760-86f2-6c701c68f2dd?from=2026-09-04&to=2026-09-04&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3003/receivables/statements" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /receivables/statements",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/receivables/write-offs" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /receivables/write-offs",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/receivables/cash-discounts?status=open&payByBefore=2026-09-04&retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call GET /receivables/cash-discounts",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/receivables/accounts?kind=asset&asOf=2026-09-04&withBalances=true&partyType=text&partyId=01a06dcf-eeae-766b-8016-3259d5ad13b9" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call GET /receivables/accounts",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/receivables/journal?refType=text&refId=01a06dee-c83b-7a4d-837e-fb9a8786f9b5&accountCode=R-0001&partyType=text&partyId=01a06dcf-eeae-766b-8016-3259d5ad13b9&from=2026-09-04&to=2026-09-04&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call GET /receivables/journal",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/receivables/ageing/rebuild" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /receivables/ageing/rebuild",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/receivables/ageing/history?from=2026-09-04&to=2026-09-04&grain=day&beatId=01a06d3e-cfdb-7635-85cb-ee42f205a04f&retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call GET /receivables/ageing/history",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/billing/queue?locationId=01a06d18-e60a-7abc-87f8-910189e5f14c&retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call GET /billing/queue",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/warehouse/packs/01a06dfc-c72b-7578-8d88-28f8e0d9054b/invoice" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /warehouse/packs/{packId}/invoice",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/invoices/van-sale" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /invoices/van-sale",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/invoices/brand-dms" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /invoices/brand-dms",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/invoices/01a06d17-0be7-794a-8dab-9b14cf78673b/cancel" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /invoices/{id}/cancel",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/invoices/01a06d17-0be7-794a-8dab-9b14cf78673b" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3003/invoices?retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd&orderId=01a06d67-52a6-70c4-8d0b-06d5bc6a56ca&state=draft&source=pack&from=2026-09-04&to=2026-09-04&openOnly=true&overdueOnly=true&q=campa&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3003/invoices/01a06d17-0be7-794a-8dab-9b14cf78673b/upi-qr" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call GET /invoices/{id}/upi-qr",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/invoices/01a06d17-0be7-794a-8dab-9b14cf78673b/pdf?copy=original&format=a4" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3003/invoices/01a06d17-0be7-794a-8dab-9b14cf78673b/eway-bill" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /invoices/{id}/eway-bill",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/invoices/01a06d17-0be7-794a-8dab-9b14cf78673b/irn" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /invoices/{id}/irn",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/credit-notes" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /credit-notes",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/credit-notes/01a06d17-0be7-794a-8dab-9b14cf78673b/issue" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /credit-notes/{id}/issue",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/credit-notes/01a06d17-0be7-794a-8dab-9b14cf78673b/cancel" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /credit-notes/{id}/cancel",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/credit-notes/01a06d17-0be7-794a-8dab-9b14cf78673b" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3003/credit-notes?invoiceId=01a06dea-de0c-7ad3-8a15-120111eb3642&retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd&reason=short_delivery&state=draft&from=2026-09-04&to=2026-09-04&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3003/billing/gst-summary?from=2026-09-04&to=2026-09-04&supplyType=B2B&groupBy=hsn" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call GET /billing/gst-summary",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/billing/sales-register?from=2026-09-04&to=2026-09-04&retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd&source=pack&issuedOnly=true&limit=100" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call GET /billing/sales-register",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/sync/errors?deviceId=01a06d91-0ce4-73b4-8bda-89cbb975a4bb&since=2026-09-04T10%3A30%3A00.000Z&unresolvedOnly=true&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3003/sync/pull?deviceId=01a06d91-0ce4-73b4-8bda-89cbb975a4bb&since=text&limit=200" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3003/notifications/messages?channel=whatsapp&status=queued&refType=order&refId=01a06dee-c83b-7a4d-837e-fb9a8786f9b5&retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd&mine=true&unreadOnly=true&from=2026-09-04&to=2026-09-04&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3003/notifications/messages/01a06d17-0be7-794a-8dab-9b14cf78673b" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3003/notifications/messages/send" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /notifications/messages/send",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/notifications/messages/01a06d17-0be7-794a-8dab-9b14cf78673b/resend" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /notifications/messages/{id}/resend",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/notifications/messages/01a06d17-0be7-794a-8dab-9b14cf78673b/read" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3003/notifications/templates?key=text&channel=whatsapp&locale=en-IN&activeOnly=true&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call GET /notifications/templates",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/notifications/templates" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /notifications/templates",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/notifications/broadcasts" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /notifications/broadcasts",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/notifications/broadcasts?beatId=01a06d3e-cfdb-7635-85cb-ee42f205a04f&channel=whatsapp&from=2026-09-04&to=2026-09-04&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call GET /notifications/broadcasts",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/notifications/broadcasts/01a06d17-0be7-794a-8dab-9b14cf78673b" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call GET /notifications/broadcasts/{id}",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/notifications/push-tokens" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3003/notifications/push-tokens/01a06d17-0be7-794a-8dab-9b14cf78673b/unregister" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3003/notifications/inbound" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /notifications/inbound",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/notifications/inbound?retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd&channel=whatsapp&handled=true&from=2026-09-04&to=2026-09-04&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3003/notifications/inbound/01a06d17-0be7-794a-8dab-9b14cf78673b/handled" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3003/incentives/targets" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /incentives/targets",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/incentives/targets/bulk" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /incentives/targets/bulk",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/incentives/targets/what-if" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /incentives/targets/what-if",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/incentives/targets/01a06d17-0be7-794a-8dab-9b14cf78673b" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3003/incentives/targets?userId=01a06d02-3731-7b6d-8798-5c7c2b7bf340&brandId=01a06db4-0f6a-71b5-8f6e-febe6219c69d&metric=value&activeOn=2026-09-04&activeOnly=true&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3003/incentives/targets/01a06d17-0be7-794a-8dab-9b14cf78673b/remove" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /incentives/targets/{id}/remove",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/incentives/targets/01a06d17-0be7-794a-8dab-9b14cf78673b/refresh" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /incentives/targets/{id}/refresh",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/incentives/progress?activeOnly=true&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3003/incentives/progress/team?metric=value&brandId=01a06db4-0f6a-71b5-8f6e-febe6219c69d&periodFrom=2026-09-04&periodTo=2026-09-04&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call GET /incentives/progress/team",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/incentives/statements/compute" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /incentives/statements/compute",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/incentives/statements/01a06d17-0be7-794a-8dab-9b14cf78673b/approve" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /incentives/statements/{id}/approve",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/incentives/statements/01a06d17-0be7-794a-8dab-9b14cf78673b/reopen" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /incentives/statements/{id}/reopen",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/incentives/statements/01a06d17-0be7-794a-8dab-9b14cf78673b" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3003/incentives/statements?userId=01a06d02-3731-7b6d-8798-5c7c2b7bf340&from=2026-09-04&to=2026-09-04&approvedOnly=true&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3003/ai/intake/text" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3003/ai/intake/voice" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3003/ai/drafts?status=parsed&retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd&source=whatsapp&from=2026-09-04&to=2026-09-04&mine=true&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3003/ai/drafts/01a06d17-0be7-794a-8dab-9b14cf78673b" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3003/ai/drafts/01a06d17-0be7-794a-8dab-9b14cf78673b/confirm" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3003/ai/drafts/01a06d17-0be7-794a-8dab-9b14cf78673b/reject" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3003/ai/forecast/run" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /ai/forecast/run",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/ai/forecast?locationId=01a06d18-e60a-7abc-87f8-910189e5f14c&variantId=01a06df0-2faf-79a2-8456-92042e49f147&horizonDays=14&coverDays=21&belowCover=true&q=campa&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call GET /ai/forecast",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/ai/routing/trips/01a06d0b-bd31-7813-8e79-aa7c39f75385/plan" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /ai/routing/trips/{tripId}/plan",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3003/ai/routing/trips/01a06d0b-bd31-7813-8e79-aa7c39f75385/plan?planId=01a06dd8-e2b2-70ec-873d-c18168012faf" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call GET /ai/routing/trips/{tripId}/plan",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3003/ai/routing/trips/01a06d0b-bd31-7813-8e79-aa7c39f75385/plan/apply" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the salesperson role may not call POST /ai/routing/trips/{tripId}/plan/apply",
  "error": "Forbidden"
}
```
