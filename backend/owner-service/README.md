...
# Owner service (`@dos/owner-service`)

Serves the **owner** role. Port **3001** (override with `OWNER_SERVICE_PORT`). Stateless: run as many replicas as needed (docs/20). Shares one Postgres database and the `@dos/core` modules with the other services (docs/19).
...
```bash
pnpm --filter @dos/owner-service dev    # watch mode on :3001
pnpm --filter @dos/owner-service test   # smoke spec: health, docs, role gate
open http://localhost:3001/docs           # interactive API reference (Scalar); /docs/openapi.json is the spec
```
...
```bash
curl "http://localhost:3001/tenancy/me" \
...
```bash
curl "http://localhost:3001/tenancy/staff" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/tenancy/staff" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
...
```bash
curl -X POST "http://localhost:3001/tenancy/staff/update" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/tenancy/staff/set-password" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/tenancy/staff/set-status" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/tenancy/branding" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3001/tenancy/settings" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/tenancy/settings" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/tenancy/numbering-series?fy=2026-27" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/tenancy/numbering-series" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/tenancy/feature-flags" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/tenancy/feature-flags" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/tenancy/tenant" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/tenancy/audit?entityType=text&entityId=01a06d21-94b0-7dc3-8aad-22f00b372c7e&actorId=01a06d81-8fbe-749f-8c31-d150f1cb90ee&action=text&from=2026-09-04&to=2026-09-04&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3001/catalog/variants?q=campa&manufacturerId=01a06d31-cc31-7f93-8dce-8b32a928ea08&brandId=01a06db4-0f6a-71b5-8f6e-febe6219c69d&includeProposed=true&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3001/catalog/manufacturers" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/catalog/proposals" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/tenant-catalog/products?q=campa&listedOnly=true&brandId=01a06db4-0f6a-71b5-8f6e-febe6219c69d&limit=200" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/tenant-catalog/products" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/tenant-catalog/suppliers" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/tenant-catalog/suppliers" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/tenant-catalog/costs?variantId=01a06df0-2faf-79a2-8456-92042e49f147&limit=200" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/tenant-catalog/costs" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/tenant-catalog/rep-authorisations?userId=01a06d02-3731-7b6d-8798-5c7c2b7bf340" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/tenant-catalog/rep-authorisations" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/tenant-catalog/brands" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/tenant-catalog/brands" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/tenant-catalog/pack-configs?supplierId=01a06d4d-b127-7ad7-815f-92d49a8a08b8&variantId=01a06df0-2faf-79a2-8456-92042e49f147&limit=200" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/tenant-catalog/pack-configs" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/retailers?q=campa&beatId=01a06d3e-cfdb-7635-85cb-ee42f205a04f&activeOnly=true&limit=100" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3001/retailers/01a06d17-0be7-794a-8dab-9b14cf78673b" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/retailers" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/retailers/01a06d17-0be7-794a-8dab-9b14cf78673b/credit" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/retailers/01a06d17-0be7-794a-8dab-9b14cf78673b/link" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/retailers/me" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the owner role may not call POST /retailers/me",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3001/beats?activeOnly=true" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/beats/01a06d17-0be7-794a-8dab-9b14cf78673b/assign" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/beats/assignments?beatId=01a06d3e-cfdb-7635-85cb-ee42f205a04f&userId=01a06d02-3731-7b6d-8798-5c7c2b7bf340&on=2026-09-04&currentOnly=true&limit=100" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3001/visits?retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd&userId=01a06d02-3731-7b6d-8798-5c7c2b7bf340&from=2026-09-04&to=2026-09-04&limit=100" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3001/pricing/price-lists?activeOnly=false&withItems=true" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/pricing/price-lists" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/pricing/price-lists/01a06d4c-b430-7575-8033-448fb7c3cd1d/items" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/pricing/overrides?retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd&variantId=01a06df0-2faf-79a2-8456-92042e49f147&on=2026-09-04&limit=200" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/pricing/overrides" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/pricing/schemes?activeOnly=true&on=2026-09-04&brandId=01a06db4-0f6a-71b5-8f6e-febe6219c69d&limit=200" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/pricing/schemes" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/pricing/quote" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/pricing/bargains" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/pricing/bargains/01a06d17-0be7-794a-8dab-9b14cf78673b/decide" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/pricing/bargains?status=requested&retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd&limit=200" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/pricing/bounds" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/pricing/bounds?userId=01a06d02-3731-7b6d-8798-5c7c2b7bf340" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3001/inventory/locations?kind=warehouse&activeOnly=true" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/inventory/locations" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/inventory/sellable?variantId=01a06df0-2faf-79a2-8456-92042e49f147&locationId=01a06d18-e60a-7abc-87f8-910189e5f14c&q=campa&limit=200" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3001/inventory/balances?variantId=01a06df0-2faf-79a2-8456-92042e49f147&locationId=01a06d18-e60a-7abc-87f8-910189e5f14c&lotId=01a06dc6-1c19-701b-8a21-982c1b2f8bc3&expiringBefore=2026-09-04&nearExpiryOnly=true&limit=200" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/inventory/adjustments" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/inventory/transfers" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/inventory/ledger?lotId=01a06dc6-1c19-701b-8a21-982c1b2f8bc3&locationId=01a06d18-e60a-7abc-87f8-910189e5f14c&from=2026-09-04&to=2026-09-04&limit=100" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/inventory/lots" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/inventory/cycle-counts" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/inventory/cycle-counts/01a06d17-0be7-794a-8dab-9b14cf78673b/count" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/inventory/cycle-counts/01a06d17-0be7-794a-8dab-9b14cf78673b/post" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/inventory/cycle-counts?locationId=01a06d18-e60a-7abc-87f8-910189e5f14c&status=open&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3001/inventory/cycle-counts/01a06d17-0be7-794a-8dab-9b14cf78673b" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/procurement/supplier-invoices" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/procurement/supplier-invoices?status=extracted&supplierId=01a06d4d-b127-7ad7-815f-92d49a8a08b8&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3001/procurement/supplier-invoices/01a06d17-0be7-794a-8dab-9b14cf78673b" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/procurement/supplier-invoices/01a06d17-0be7-794a-8dab-9b14cf78673b/lines/01a06db2-da39-7334-863c-3d85d8b13619/match" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/procurement/supplier-invoices/01a06d17-0be7-794a-8dab-9b14cf78673b/dispute" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/procurement/supplier-invoices/01a06d17-0be7-794a-8dab-9b14cf78673b/cancel" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/procurement/grns" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/procurement/grns/01a06d17-0be7-794a-8dab-9b14cf78673b/count" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/procurement/grns/01a06d17-0be7-794a-8dab-9b14cf78673b/post" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/procurement/grns?status=counting&supplierInvoiceId=01a06d82-1775-71ad-8088-b75bd47cfb24&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3001/procurement/grns/01a06d17-0be7-794a-8dab-9b14cf78673b" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3001/procurement/discrepancies?grnId=01a06dbb-51b1-75fd-83c0-1b162ad95028&status=open&kind=short&limit=100" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/procurement/discrepancies/01a06d17-0be7-794a-8dab-9b14cf78673b/resolve" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/procurement/purchase-orders" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/procurement/purchase-orders?supplierId=01a06d4d-b127-7ad7-815f-92d49a8a08b8&status=draft&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/orders/01a06d17-0be7-794a-8dab-9b14cf78673b/lines" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/orders/repeat-last" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/orders/01a06d17-0be7-794a-8dab-9b14cf78673b/submit" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/orders/01a06d17-0be7-794a-8dab-9b14cf78673b/confirm" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/orders/01a06d17-0be7-794a-8dab-9b14cf78673b/cancel" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/orders/01a06d17-0be7-794a-8dab-9b14cf78673b" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3001/orders?state=draft&openOnly=true&retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd&salespersonId=01a06d29-a152-76c4-87b4-301e496c0602&from=2026-09-04&to=2026-09-04&q=campa&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3001/approvals?status=pending&orderId=01a06d67-52a6-70c4-8d0b-06d5bc6a56ca&kind=credit_limit&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/approvals/01a06d17-0be7-794a-8dab-9b14cf78673b/decide" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/receipts" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/receipts/01a06d17-0be7-794a-8dab-9b14cf78673b" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3001/receipts/01a06d17-0be7-794a-8dab-9b14cf78673b/document?format=a5" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/receipts/01a06d17-0be7-794a-8dab-9b14cf78673b/reverse" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/receipts/deposit" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/receipts/01a06d17-0be7-794a-8dab-9b14cf78673b/bounce" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/receivables/payments/initiate" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the owner role may not call POST /receivables/payments/initiate",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3001/allocations" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/allocations/01a06d17-0be7-794a-8dab-9b14cf78673b/remove" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/receivables/outstanding/01a06dbc-35ed-7760-86f2-6c701c68f2dd?includeBills=true" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3001/receivables/outstanding?beatId=01a06d3e-cfdb-7635-85cb-ee42f205a04f&overdueOnly=true&minOutstandingPaise=2680000&bucket=b0_7&q=campa&sort=outstanding&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3001/receivables/credit-check?retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd&orderTotalPaise=0" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3001/receivables/ledger/01a06dbc-35ed-7760-86f2-6c701c68f2dd?from=2026-09-04&to=2026-09-04&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/receivables/statements" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/receivables/write-offs" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/receivables/cash-discounts?status=open&payByBefore=2026-09-04&retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3001/receivables/accounts?kind=asset&asOf=2026-09-04&withBalances=true&partyType=text&partyId=01a06dcf-eeae-766b-8016-3259d5ad13b9" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3001/receivables/journal?refType=text&refId=01a06dee-c83b-7a4d-837e-fb9a8786f9b5&accountCode=R-0001&partyType=text&partyId=01a06dcf-eeae-766b-8016-3259d5ad13b9&from=2026-09-04&to=2026-09-04&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/receivables/ageing/rebuild" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/receivables/ageing/history?from=2026-09-04&to=2026-09-04&grain=day&beatId=01a06d3e-cfdb-7635-85cb-ee42f205a04f&retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3001/billing/queue?locationId=01a06d18-e60a-7abc-87f8-910189e5f14c&retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/warehouse/packs/01a06dfc-c72b-7578-8d88-28f8e0d9054b/invoice" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/invoices/van-sale" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/invoices/brand-dms" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/invoices/01a06d17-0be7-794a-8dab-9b14cf78673b/cancel" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/invoices/01a06d17-0be7-794a-8dab-9b14cf78673b" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3001/invoices?retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd&orderId=01a06d67-52a6-70c4-8d0b-06d5bc6a56ca&state=draft&source=pack&from=2026-09-04&to=2026-09-04&openOnly=true&overdueOnly=true&q=campa&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3001/invoices/01a06d17-0be7-794a-8dab-9b14cf78673b/upi-qr" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3001/invoices/01a06d17-0be7-794a-8dab-9b14cf78673b/pdf?copy=original&format=a4" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/invoices/01a06d17-0be7-794a-8dab-9b14cf78673b/eway-bill" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/invoices/01a06d17-0be7-794a-8dab-9b14cf78673b/irn" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/credit-notes" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/credit-notes/01a06d17-0be7-794a-8dab-9b14cf78673b/issue" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/credit-notes/01a06d17-0be7-794a-8dab-9b14cf78673b/cancel" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/credit-notes/01a06d17-0be7-794a-8dab-9b14cf78673b" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3001/credit-notes?invoiceId=01a06dea-de0c-7ad3-8a15-120111eb3642&retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd&reason=short_delivery&state=draft&from=2026-09-04&to=2026-09-04&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3001/billing/gst-summary?from=2026-09-04&to=2026-09-04&supplyType=B2B&groupBy=hsn" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3001/billing/sales-register?from=2026-09-04&to=2026-09-04&retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd&source=pack&issuedOnly=true&limit=100" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/warehouse/load-sheets/01a06d17-0be7-794a-8dab-9b14cf78673b/approve" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/warehouse/challans/01a06d17-0be7-794a-8dab-9b14cf78673b/pdf?copy=original&format=a4" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/sync/upload" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/sync/errors?deviceId=01a06d91-0ce4-73b4-8bda-89cbb975a4bb&since=2026-09-04T10%3A30%3A00.000Z&unresolvedOnly=true&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3001/sync/pull?deviceId=01a06d91-0ce4-73b4-8bda-89cbb975a4bb&since=text&limit=200" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3001/files/read-url?objectKey=docs%2F2026%2F09%2Finvoice-0042.jpg" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3001/notifications/messages?channel=whatsapp&status=queued&refType=order&refId=01a06dee-c83b-7a4d-837e-fb9a8786f9b5&retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd&mine=true&unreadOnly=true&from=2026-09-04&to=2026-09-04&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3001/notifications/messages/01a06d17-0be7-794a-8dab-9b14cf78673b" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/notifications/messages/send" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/notifications/messages/01a06d17-0be7-794a-8dab-9b14cf78673b/resend" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/notifications/messages/01a06d17-0be7-794a-8dab-9b14cf78673b/read" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/notifications/templates?key=text&channel=whatsapp&locale=en-IN&activeOnly=true&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/notifications/templates" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/notifications/broadcasts" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/notifications/broadcasts?beatId=01a06d3e-cfdb-7635-85cb-ee42f205a04f&channel=whatsapp&from=2026-09-04&to=2026-09-04&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3001/notifications/broadcasts/01a06d17-0be7-794a-8dab-9b14cf78673b" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/notifications/push-tokens" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3001/notifications/push-tokens/01a06d17-0be7-794a-8dab-9b14cf78673b/unregister" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3001/notifications/inbound?retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd&channel=whatsapp&handled=true&from=2026-09-04&to=2026-09-04&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3001/notifications/inbound/01a06d17-0be7-794a-8dab-9b14cf78673b/handled" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
