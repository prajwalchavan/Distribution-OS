/**
 * The delivery crew service (:3005) — the composition itself lives in `@dos/core` (`libs/core/src/service/definitions.ts`), and
 ...
 */
export { deliveryServiceDefinition as service } from '@dos/core'
