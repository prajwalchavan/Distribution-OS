/**
 * Sign-in for every app (:3000) — the composition itself lives in `@dos/core` (`libs/core/src/service/definitions.ts`), and
 ...
 */
export { authServiceDefinition as service } from '@dos/core'
