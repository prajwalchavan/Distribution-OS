...
```bash
curl -X POST "http://localhost:3004/tenancy/memberships/update" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call POST /tenancy/memberships/update",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/tenancy/support-grants?status=requested&openOnly=true&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /tenancy/support-grants",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3004/tenancy/support-grants/01a06d17-0be7-794a-8dab-9b14cf78673b/approve" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call POST /tenancy/support-grants/{id}/approve",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3004/tenancy/support-grants/01a06d17-0be7-794a-8dab-9b14cf78673b/revoke" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call POST /tenancy/support-grants/{id}/revoke",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/catalog/hsn-rates?codes=22021010&on=2026-09-04" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
Blind gate count: pieces received and damaged per line (no expected figure, no short or excess finding) · contract `procurement.grns.count`
...
```bash
curl "http://localhost:3004/orders/last-placed?retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3004/sync/manifest?knownSchemaVersion=text" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call POST /delivery/trips/{id}/depart",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3004/docint/documents" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3004/docint/documents/01a06d17-0be7-794a-8dab-9b14cf78673b/pages/upload-urls" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3004/docint/documents/01a06d17-0be7-794a-8dab-9b14cf78673b/pages" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3004/docint/documents/01a06d17-0be7-794a-8dab-9b14cf78673b/qr" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3004/docint/documents/01a06d17-0be7-794a-8dab-9b14cf78673b/submit" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3004/docint/documents?kind=supplier_invoice&status=uploaded&supplierId=01a06d4d-b127-7ad7-815f-92d49a8a08b8&uploadedBy=01a06db0-2f89-716c-8fee-411b6df534d6&mine=true&from=2026-09-04&to=2026-09-04&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3004/docint/documents/01a06d17-0be7-794a-8dab-9b14cf78673b" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3004/docint/documents/01a06d17-0be7-794a-8dab-9b14cf78673b/status" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3004/docint/documents/01a06d17-0be7-794a-8dab-9b14cf78673b/page-url?pageNo=1" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3004/docint/documents/01a06d17-0be7-794a-8dab-9b14cf78673b/reject" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call POST /docint/documents/{id}/reject",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3004/docint/documents/01a06d17-0be7-794a-8dab-9b14cf78673b/approve" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call POST /docint/documents/{id}/approve",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3004/docint/documents/01a06d17-0be7-794a-8dab-9b14cf78673b/extract" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call POST /docint/documents/{id}/extract",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/docint/documents/01a06d17-0be7-794a-8dab-9b14cf78673b/extractions?includeResult=false" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /docint/documents/{id}/extractions",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/docint/extractions/01a06d17-0be7-794a-8dab-9b14cf78673b" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /docint/extractions/{id}",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/docint/extractions/01a06d61-15b4-76ba-8090-83e7be1dbc48/candidates?lineNo=1&unmatchedOnly=true&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /docint/extractions/{extractionId}/candidates",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3004/docint/extractions/01a06d17-0be7-794a-8dab-9b14cf78673b/matches/accept" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call POST /docint/extractions/{id}/matches/accept",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3004/docint/extractions/01a06d17-0be7-794a-8dab-9b14cf78673b/matches/reject" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call POST /docint/extractions/{id}/matches/reject",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3004/docint/extractions/01a06d17-0be7-794a-8dab-9b14cf78673b/matches/choose" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call POST /docint/extractions/{id}/matches/choose",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3004/docint/extractions/01a06d17-0be7-794a-8dab-9b14cf78673b/rematch" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call POST /docint/extractions/{id}/rematch",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3004/docint/documents/01a06d17-0be7-794a-8dab-9b14cf78673b/review" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call POST /docint/documents/{id}/review",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3004/docint/review-sessions/01a06d17-0be7-794a-8dab-9b14cf78673b/heartbeat" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call POST /docint/review-sessions/{id}/heartbeat",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3004/docint/review-sessions/01a06d17-0be7-794a-8dab-9b14cf78673b" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call POST /docint/review-sessions/{id}",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3004/docint/review-sessions/01a06d17-0be7-794a-8dab-9b14cf78673b/release" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call POST /docint/review-sessions/{id}/release",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3004/docint/review-sessions/01a06d17-0be7-794a-8dab-9b14cf78673b/submit" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call POST /docint/review-sessions/{id}/submit",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/docint/queue?status=extracted&kind=supplier_invoice&supplierId=01a06d4d-b127-7ad7-815f-92d49a8a08b8&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /docint/queue",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/docint/stats?from=2026-09-04&to=2026-09-04&supplierId=01a06d4d-b127-7ad7-815f-92d49a8a08b8&kind=supplier_invoice" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /docint/stats",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/notifications/messages?channel=whatsapp&status=queued&refType=order&refId=01a06dee-c83b-7a4d-837e-fb9a8786f9b5&retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd&mine=true&unreadOnly=true&from=2026-09-04&to=2026-09-04&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3004/notifications/messages/01a06d17-0be7-794a-8dab-9b14cf78673b" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3004/notifications/messages/send" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call POST /notifications/messages/send",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3004/notifications/messages/01a06d17-0be7-794a-8dab-9b14cf78673b/resend" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call POST /notifications/messages/{id}/resend",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3004/notifications/messages/01a06d17-0be7-794a-8dab-9b14cf78673b/read" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3004/notifications/templates?key=text&channel=whatsapp&locale=en-IN&activeOnly=true&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /notifications/templates",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3004/notifications/templates" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call POST /notifications/templates",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3004/notifications/broadcasts" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call POST /notifications/broadcasts",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/notifications/broadcasts?beatId=01a06d3e-cfdb-7635-85cb-ee42f205a04f&channel=whatsapp&from=2026-09-04&to=2026-09-04&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /notifications/broadcasts",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/notifications/broadcasts/01a06d17-0be7-794a-8dab-9b14cf78673b" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /notifications/broadcasts/{id}",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3004/notifications/push-tokens" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl -X POST "http://localhost:3004/notifications/push-tokens/01a06d17-0be7-794a-8dab-9b14cf78673b/unregister" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
```bash
curl "http://localhost:3004/notifications/inbound?retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd&channel=whatsapp&handled=true&from=2026-09-04&to=2026-09-04&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /notifications/inbound",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3004/notifications/inbound/01a06d17-0be7-794a-8dab-9b14cf78673b/handled" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call POST /notifications/inbound/{id}/handled",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/reporting/dashboard/owner" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /reporting/dashboard/owner",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/reporting/dashboard/rep?userId=01a06d02-3731-7b6d-8798-5c7c2b7bf340" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /reporting/dashboard/rep",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/reporting/series?metric=invoiced&grain=day&from=2026-09-04&to=2026-09-04&groupBy=brand&topGroups=12&compare=none" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /reporting/series",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/reporting/series/sales?grain=day&from=2026-09-04&to=2026-09-04&groupBy=brand&topGroups=12&compare=none&brandId=01a06db4-0f6a-71b5-8f6e-febe6219c69d&beatId=01a06d3e-cfdb-7635-85cb-ee42f205a04f" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /reporting/series/sales",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/reporting/series/collections?grain=day&from=2026-09-04&to=2026-09-04&groupBy=paymentMode&compare=none" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /reporting/series/collections",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/reporting/series/outstanding?grain=day&from=2026-09-04&to=2026-09-04&beatId=01a06d3e-cfdb-7635-85cb-ee42f205a04f&retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /reporting/series/outstanding",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/reporting/series/ageing?grain=week&from=2026-09-04&to=2026-09-04&beatId=01a06d3e-cfdb-7635-85cb-ee42f205a04f&retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /reporting/series/ageing",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/reporting/series/growth?metric=invoiced&basis=mom&from=2026-09-04&to=2026-09-04" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /reporting/series/growth",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/reporting/series/brand-mix?grain=month&from=2026-09-04&to=2026-09-04&topGroups=5" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /reporting/series/brand-mix",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/reporting/series/category-mix?grain=month&from=2026-09-04&to=2026-09-04&topGroups=5" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /reporting/series/category-mix",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/reporting/series/top-shops?metric=invoiced&from=2026-09-04&to=2026-09-04&top=10&compare=none&beatId=01a06d3e-cfdb-7635-85cb-ee42f205a04f&salespersonId=01a06d29-a152-76c4-87b4-301e496c0602" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /reporting/series/top-shops",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/reporting/series/top-beats?metric=invoiced&from=2026-09-04&to=2026-09-04&top=10&compare=none" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /reporting/series/top-beats",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/reporting/series/productivity?grain=day&from=2026-09-04&to=2026-09-04&userId=01a06d02-3731-7b6d-8798-5c7c2b7bf340&beatId=01a06d3e-cfdb-7635-85cb-ee42f205a04f&compare=none" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /reporting/series/productivity",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/reporting/series/fill-rate?grain=day&from=2026-09-04&to=2026-09-04&compare=none" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3004/reporting/series/delivery-performance?grain=day&from=2026-09-04&to=2026-09-04&driverId=01a06d0f-6f2a-7a8b-8ee0-f77be48eb068&vehicleId=01a06d9c-98d8-7445-8ff2-d0ee7a6163da&compare=none" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /reporting/series/delivery-performance",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/reporting/series/stock?grain=month&from=2026-09-04&to=2026-09-04&compare=none" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /reporting/series/stock",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/reporting/series/gross-margin?grain=month&from=2026-09-04&to=2026-09-04&groupBy=brand&topGroups=12&compare=none" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /reporting/series/gross-margin",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/reporting/series/scheme-spend?grain=month&from=2026-09-04&to=2026-09-04&compare=none" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /reporting/series/scheme-spend",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/reporting/registers/daily-sales?from=2026-09-04&to=2026-09-04&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /reporting/registers/daily-sales",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/reporting/registers/rep-daily?from=2026-09-04&to=2026-09-04&userId=01a06d02-3731-7b6d-8798-5c7c2b7bf340&beatId=01a06d3e-cfdb-7635-85cb-ee42f205a04f&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /reporting/registers/rep-daily",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/reporting/retailers/01a06d17-0be7-794a-8dab-9b14cf78673b/behaviour" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /reporting/retailers/{id}/behaviour",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/reporting/retailers/01a06d17-0be7-794a-8dab-9b14cf78673b/series?grain=week&buckets=12" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /reporting/retailers/{id}/series",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/reporting/retailers/lapsed?beatId=01a06d3e-cfdb-7635-85cb-ee42f205a04f&minRisk=30&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /reporting/retailers/lapsed",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/reporting/registers/rep-productivity?from=2026-09-04&to=2026-09-04&beatId=01a06d3e-cfdb-7635-85cb-ee42f205a04f&userId=01a06d02-3731-7b6d-8798-5c7c2b7bf340&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /reporting/registers/rep-productivity",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/reporting/registers/scheme-spend?from=2026-09-04&to=2026-09-04&brandId=01a06db4-0f6a-71b5-8f6e-febe6219c69d&schemeId=01a06daf-72be-7837-8605-139be7237dfd&fundingSource=company&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /reporting/registers/scheme-spend",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/reporting/registers/stock-value?locationId=01a06d18-e60a-7abc-87f8-910189e5f14c&brandId=01a06db4-0f6a-71b5-8f6e-febe6219c69d&nearExpiryDays=90&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /reporting/registers/stock-value",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/reporting/registers/fill-rate?from=2026-09-04&to=2026-09-04&locationId=01a06d18-e60a-7abc-87f8-910189e5f14c&salespersonId=01a06d29-a152-76c4-87b4-301e496c0602&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl "http://localhost:3004/reporting/registers/delivery-performance?from=2026-09-04&to=2026-09-04&vehicleId=01a06d9c-98d8-7445-8ff2-d0ee7a6163da&driverId=01a06d0f-6f2a-7a8b-8ee0-f77be48eb068&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /reporting/registers/delivery-performance",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/reporting/registers/collections?from=2026-09-04&to=2026-09-04&mode=cash&groupBy=day&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /reporting/registers/collections",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/reporting/registers/gst-sales?from=2026-09-04&to=2026-09-04&supplyType=B2B&groupBy=hsn" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /reporting/registers/gst-sales",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/reporting/registers/gst-purchase?from=2026-09-04&to=2026-09-04&supplierId=01a06d4d-b127-7ad7-815f-92d49a8a08b8" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /reporting/registers/gst-purchase",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3004/reporting/exports" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call POST /reporting/exports",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/reporting/exports/01a06d17-0be7-794a-8dab-9b14cf78673b" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /reporting/exports/{id}",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3004/ai/intake/text" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call POST /ai/intake/text",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3004/ai/intake/voice" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call POST /ai/intake/voice",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/ai/drafts?status=parsed&retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd&source=whatsapp&from=2026-09-04&to=2026-09-04&mine=true&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /ai/drafts",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/ai/drafts/01a06d17-0be7-794a-8dab-9b14cf78673b" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call GET /ai/drafts/{id}",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3004/ai/drafts/01a06d17-0be7-794a-8dab-9b14cf78673b/confirm" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call POST /ai/drafts/{id}/confirm",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3004/ai/drafts/01a06d17-0be7-794a-8dab-9b14cf78673b/reject" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call POST /ai/drafts/{id}/reject",
  "error": "Forbidden"
}
```
...
```bash
curl -X POST "http://localhost:3004/ai/forecast/run" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call POST /ai/forecast/run",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/ai/forecast?locationId=01a06d18-e60a-7abc-87f8-910189e5f14c&variantId=01a06df0-2faf-79a2-8456-92042e49f147&horizonDays=14&coverDays=21&belowCover=true&q=campa&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3004/ai/routing/trips/01a06d0b-bd31-7813-8e79-aa7c39f75385/plan" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call POST /ai/routing/trips/{tripId}/plan",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3004/ai/routing/trips/01a06d0b-bd31-7813-8e79-aa7c39f75385/plan?planId=01a06dd8-e2b2-70ec-873d-c18168012faf" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3004/ai/routing/trips/01a06d0b-bd31-7813-8e79-aa7c39f75385/plan/apply" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the warehouse role may not call POST /ai/routing/trips/{tripId}/plan/apply",
  "error": "Forbidden"
}
```
