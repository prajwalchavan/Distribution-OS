...
{
  "statusCode": 403,
  "message": "the retailer role may not call GET /pricing/schemes",
  "error": "Forbidden"
}
```
...
{
  "statusCode": 403,
  "message": "the retailer role may not call GET /pricing/bargains",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3006/inventory/balances?variantId=01a06df0-2faf-79a2-8456-92042e49f147&locationId=01a06d18-e60a-7abc-87f8-910189e5f14c&lotId=01a06dc6-1c19-701b-8a21-982c1b2f8bc3&limit=200" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
{
  "statusCode": 403,
  "message": "the retailer role may not call POST /orders/{id}/submit",
  "error": "Forbidden"
}
```
...
```bash
curl "http://localhost:3006/orders?state=draft&retailerId=01a06dbc-35ed-7760-86f2-6c701c68f2dd&salespersonId=01a06d29-a152-76c4-87b4-301e496c0602&from=2026-09-04&to=2026-09-04&q=campa&limit=50" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…"
```
...
```bash
curl -X POST "http://localhost:3006/invoices" \
  -H "Authorization: Bearer eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwMWEwNmQ4Zi04NzY1LTc0MzItODAwOS1hYmNkZWYwMTIzNDUi…" \
  -H "content-type: application/json" \
  -d @request.json
```
...
{
  "statusCode": 403,
  "message": "the retailer role may not call POST /invoices",
  "error": "Forbidden"
}
```
