CREATE TYPE "public"."allocation_mode" AS ENUM('server', 'device', 'external');--> statement-breakpoint
...
CREATE TYPE "public"."cash_discount_mode" AS ENUM('on_invoice', 'at_receipt_financial_cn');--> statement-breakpoint
CREATE TYPE "public"."claim_channel" AS ENUM('dos', 'brand_dms');--> statement-breakpoint
CREATE TYPE "public"."fulfilment_mode" AS ENUM('own', 'brand_dms');--> statement-breakpoint
CREATE TYPE "public"."margin_basis" AS ENUM('ptd', 'mrp', 'net');--> statement-breakpoint
CREATE TYPE "public"."tally_export_source" AS ENUM('dos', 'brand_dms', 'none');--> statement-breakpoint
...
CREATE TYPE "public"."retailer_link_role" AS ENUM('owner', 'staff');--> statement-breakpoint
...
CREATE TYPE "public"."floor_basis" AS ENUM('tier_price', 'ptr');--> statement-breakpoint
...
CREATE TYPE "public"."reward_unit" AS ENUM('pcs', 'case');--> statement-breakpoint
...
CREATE TYPE "public"."entered_unit" AS ENUM('piece', 'inner', 'case');--> statement-breakpoint
...
CREATE TYPE "public"."rate_basis" AS ENUM('piece', 'case');--> statement-breakpoint
...
CREATE TABLE "tenant_brands" (
	...
	"tenant_id" text NOT NULL,
	"brand_id" text NOT NULL,
	"fulfilment_mode" "fulfilment_mode" DEFAULT 'own' NOT NULL,
	"tally_export_source" "tally_export_source" DEFAULT 'dos' NOT NULL,
	"cash_discount_mode" "cash_discount_mode" DEFAULT 'at_receipt_financial_cn' NOT NULL,
	"claim_channel" "claim_channel" DEFAULT 'dos' NOT NULL,
	"sales_force" text DEFAULT 'distributor' NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL
);
--> statement-breakpoint
ALTER TABLE "tenant_brands" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
CREATE TABLE "external_party_codes" (
	"id" text PRIMARY KEY NOT NULL,
	"tenant_id" text NOT NULL,
	"system" text NOT NULL,
	"code" text NOT NULL,
...
--> statement-breakpoint
ALTER TABLE "external_party_codes" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
CREATE TABLE "pjp" (
	"id" text PRIMARY KEY NOT NULL,
	"tenant_id" text NOT NULL,
	"beat_id" text NOT NULL,
...
--> statement-breakpoint
ALTER TABLE "retailer_purchase_history" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
CREATE TABLE "rep_auto_approve_bounds" (
	...
	"floor_basis" "floor_basis" DEFAULT 'tier_price' NOT NULL,
	"max_per_piece_paise" bigint,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE "schemes" (
	...
	"reward_unit" "reward_unit" DEFAULT 'pcs' NOT NULL,
...
CREATE TABLE "sales_order_lines" (
	...
	"entered_unit" "entered_unit" DEFAULT 'piece' NOT NULL,
	"pack_size_at_entry" integer DEFAULT 1 NOT NULL,
	"qty_pcs" integer NOT NULL,
...
CREATE TABLE "supplier_invoice_lines" (
	...
	"free_qty_pcs" integer DEFAULT 0 NOT NULL,
	"rate_paise" bigint NOT NULL,
	"rate_basis" "rate_basis" DEFAULT 'piece' NOT NULL,
	"basis_qty" integer DEFAULT 1 NOT NULL,
	"discount_bps" integer DEFAULT 0 NOT NULL,
	"discount_paise" bigint DEFAULT 0 NOT NULL,
...
ALTER TABLE "numbering_series" ADD COLUMN "allocation_mode" "allocation_mode" DEFAULT 'server' NOT NULL;--> statement-breakpoint
ALTER TABLE "numbering_series" ADD COLUMN "starting_no" integer DEFAULT 1 NOT NULL;--> statement-breakpoint
ALTER TABLE "numbering_series" ADD COLUMN "device_id" text;--> statement-breakpoint
...
ALTER TABLE "tenant_brands" ADD CONSTRAINT "tenant_brands_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "tenant_brands" ADD CONSTRAINT "tenant_brands_brand_id_brands_id_fk" FOREIGN KEY ("brand_id") REFERENCES "public"."brands"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "external_party_codes" ADD CONSTRAINT "external_party_codes_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "external_party_codes" ADD CONSTRAINT "external_party_codes_retailer_id_retailers_id_fk" FOREIGN KEY ("retailer_id") REFERENCES "public"."retailers"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "retailer_purchase_history" ADD CONSTRAINT "retailer_purchase_history_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "retailer_purchase_history" ADD CONSTRAINT "retailer_purchase_history_retailer_id_retailers_id_fk" FOREIGN KEY ("retailer_id") REFERENCES "public"."retailers"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "delivery_challans" ADD CONSTRAINT "delivery_challans_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "delivery_challans" ADD CONSTRAINT "delivery_challans_load_sheet_id_load_sheets_id_fk" FOREIGN KEY ("load_sheet_id") REFERENCES "public"."load_sheets"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "delivery_challans" ADD CONSTRAINT "delivery_challans_from_location_id_locations_id_fk" FOREIGN KEY ("from_location_id") REFERENCES "public"."locations"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "delivery_challans" ADD CONSTRAINT "delivery_challans_to_location_id_locations_id_fk" FOREIGN KEY ("to_location_id") REFERENCES "public"."locations"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "delivery_challans" ADD CONSTRAINT "delivery_challans_issued_by_users_id_fk" FOREIGN KEY ("issued_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "tenant_brands_idx" ON "tenant_brands" USING btree ("tenant_id","brand_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "external_party_codes_idx" ON "external_party_codes" USING btree ("tenant_id","system","code");--> statement-breakpoint
CREATE INDEX "external_party_codes_retailer_idx" ON "external_party_codes" USING btree ("tenant_id","retailer_id");--> statement-breakpoint
...
CREATE INDEX "retailer_purchase_history_idx" ON "retailer_purchase_history" USING btree ("tenant_id","retailer_id","invoice_date");--> statement-breakpoint
...
CREATE INDEX "delivery_challans_load_sheet_idx" ON "delivery_challans" USING btree ("tenant_id","load_sheet_id");--> statement-breakpoint
...
CREATE POLICY "tenant_brands_tenant" ON "tenant_brands" AS PERMISSIVE FOR ALL TO "app_rw" USING (tenant_id = (SELECT current_setting('app.tenant_id', true))) WITH CHECK (tenant_id = (SELECT current_setting('app.tenant_id', true)));--> statement-breakpoint
...
CREATE POLICY "external_party_codes_tenant" ON "external_party_codes" AS PERMISSIVE FOR ALL TO "app_rw" USING (tenant_id = (SELECT current_setting('app.tenant_id', true))) WITH CHECK (tenant_id = (SELECT current_setting('app.tenant_id', true)));--> statement-breakpoint
...
CREATE POLICY "retailer_purchase_history_tenant" ON "retailer_purchase_history" AS PERMISSIVE FOR ALL TO "app_rw" USING (tenant_id = (SELECT current_setting('app.tenant_id', true))) WITH CHECK (tenant_id = (SELECT current_setting('app.tenant_id', true)));--> statement-breakpoint
...
CREATE POLICY "delivery_challans_tenant" ON "delivery_challans" AS PERMISSIVE FOR ALL TO "app_rw" USING (tenant_id = (SELECT current_setting('app.tenant_id', true))) WITH CHECK (tenant_id = (SELECT current_setting('app.tenant_id', true)));--> statement-breakpoint
