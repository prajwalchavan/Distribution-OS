/**
 * The platform console service (:3007, module 13) — the composition itself lives in `@dos/core` (`libs/core/src/service/definitions.ts`), and
 ...
 */
export { adminServiceDefinition as service } from '@dos/core'
