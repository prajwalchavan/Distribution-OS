...
import { checkCredit, loadRetailerCredit } from './credit.js'
...
export async function createDraft(
  ...
  if (clash) throw new ORPCError('CONFLICT', { message: `order ${input.id} already exists` })
...
export async function emitOrderEvent(
  tx: Db,
  order: OrderRow,
  eventType: 'OrderSubmitted' | 'OrderConfirmed' | 'OrderCancelled',
): Promise<void> {
