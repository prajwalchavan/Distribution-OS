...
backend/worker                pg-boss consumers (outbox relay, retention; later docint/imports/rollups).
backend/tools                 generate-readmes.mts, auth-keygen.mts.        backend/infra: Dockerfile, compose, notes.
